...
}, "app/controllers/home_controller": function(exports, require, module) {module.exports = {
...
module.exports = RendrBase.extend({});
}, "app/router": function(exports, require, module) {var BaseClientRouter = require('rendr/client/router');
...
}, "app/views/home_index_view": function(exports, require, module) {var BaseView = require('./base_view');

module.exports = BaseView.extend({
	className: 'home_index_view'
});
module.exports.id = 'HomeIndexView';
}, "rendr/client/router": function(exports, require, module) {(function() {
  var AppView, BaseRouter, BaseView, ClientRouter, e, extractParamNamesRe, firstRender, noop, plusRe,
  ...
  module.exports = ClientRouter = (function(_super) {
    ...
    function ClientRouter(options) {
      this.trackAction = __bind(this.trackAction, this);
      this.renderView = __bind(this.renderView, this);
      this.render = __bind(this.render, this);
      this.addBackboneRoute = __bind(this.addBackboneRoute, this);      this._router = new Backbone.Router;
    ...
    ClientRouter.prototype.initialize = function(options) {
      ...
      this.on('route:add', this.addBackboneRoute);
      this.buildRoutes();
      this.on('action:start', this.trackAction);
      this.app.on('reload', this.renderView);
    ...
    ClientRouter.prototype.addBackboneRoute = function(routeObj) {
      ...
      pattern = routeObj[0], route = routeObj[1], handler = routeObj[2];
      name = "" + route.controller + ":" + route.action;
      return this._router.route(pattern.slice(1), name, handler);
    };
    ...
    ClientRouter.prototype.getHandler = function(action, pattern, route) {
      ...
      return function() {
        var params, paramsArray, renderCallback, views;

        paramsArray = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        _this.trigger('action:start', route, firstRender);
        _this.currentRoute = route;
        if (firstRender) {
          views = BaseView.attach(_this.app);
          _this.currentView = _this.getMainView(views);
          _this.trigger('action:end', route, firstRender);
          return firstRender = false;
        } else {
          params = _this.getParamsHash(pattern, paramsArray, window.location.search);
          if (!action) {
          ...
          renderCallback = function() {
            ...
            return _this.trigger('action:end', route, firstRender);
          };
          return action.call(_this, params, renderCallback);
        }
      };
    };
    ...
    ClientRouter.prototype.navigate = function() {
      ...
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return this._router.navigate.apply(this._router, args);
    };
    ...
    ClientRouter.prototype.redirectTo = function(path, options) {
      ...
      if (hashParts.length > 1) {
        hashHandler = function() {
          ...
          return _this.off('action:end', hashHandler);
        };
        this.on('action:end', hashHandler);
      }
      return this.navigate(path, options);
    };

    ClientRouter.prototype.render = function(err, view_key, data) {
      var View;
      ...
      data.app = this.app;
      View = this.getView(view_key);
      this.currentView = new View(data);
      return this.renderView();
    };

    ClientRouter.prototype.renderView = function() {
      return this.appView.setCurrentView(this.currentView);
    };
    ...
    ClientRouter.prototype.trackAction = function(route) {
      this.previousFragment = this.currentFragment;
      return this.currentFragment = Backbone.history.getFragment();
    };
...
}, "rendr/shared/app": function(exports, require, module) {(function() {
  var App, ClientRouter, Fetcher, noop, _ref,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    __slice = [].slice;
  ...
  module.exports = App = (function(_super) {
    ...
    App.prototype.fetch = function() {
      ...
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return this.fetcher.fetch.apply(this.fetcher, args);
    };

    App.prototype.bootstrapData = function(modelMap) {
      return this.fetcher.bootstrapData(modelMap);
    };
...
}, "rendr/shared/base/app_view": function(exports, require, module) {(function() {
  var AppView, BaseView, hasPushState, _ref,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  hasPushState = (typeof window !== "undefined" && window !== null ? window.history.pushState : void 0) != null;

  module.exports = AppView = (function(_super) {
    __extends(AppView, _super);

    function AppView() {
      this._interceptClick = __bind(this._interceptClick, this);      _ref = AppView.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    AppView.prototype.initialize = function() {
      ...
      return this._bindInterceptClick();
    };
    ...
    AppView.prototype._bindInterceptClick = function() {
      return this.$el.on('click', 'a:not([data-pass-thru])', this._interceptClick);
    };
    ...
    AppView.prototype._interceptClick = function(e) {
      ...
      if (this.shouldInterceptClick(href, e.currentTarget)) {
        e.preventDefault();
        return this.app.router.redirectTo(href);
      }
    };
...
}, "rendr/shared/base/collection": function(exports, require, module) {(function() {
  var Base, BaseModel, syncer,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  module.exports = Base = (function(_super) {
    ...
    Base.prototype.parse = function(resp, modifyInstance) {
      ...
      parsed = this.jsonKey && (jsonResp = resp[this.jsonKey]) ? (modifyInstance ? (meta = _.omit(resp, this.jsonKey), _.extend(this.meta, meta)) : void 0, jsonResp) : resp;
      return this.parseModels(parsed);
    };

    Base.prototype.parseModels = function(resp) {
      var i, jsonKey, jsonKeyResp, modelResp, _i, _len;
    ...
    Base.prototype.store = function() {
      ...
      return this.app.fetcher.collectionStore.set(this);
    };
...
}, "rendr/shared/base/model": function(exports, require, module) {(function() {
  var Base, syncer,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  module.exports = Base = (function(_super) {
    ...
    Base.prototype.add = function(models, options) {
      var model, _i, _len;
      ...
      return Base.__super__.add.call(this, models, options);
    };
    ...
    Base.prototype.store = function() {
      return this.app.fetcher.modelStore.set(this);
    };
...
}, "rendr/shared/base/router": function(exports, require, module) {(function() {
  var Backbone, BaseRouter, isServer, noop, _,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __slice = [].slice;

  isServer = typeof window === "undefined" || window === null;

  _ = isServer ? require('underscore') : window._;

  Backbone = isServer ? require('backbone') : window.Backbone;
  ...
  module.exports = BaseRouter = (function() {
    ...
    function BaseRouter(options) {
      this.route = __bind(this.route, this);      this._routes = [];
    ...
    BaseRouter.prototype._initOptions = function(options) {
      ...
      this.options = options || {};
      (_base = this.options).paths || (_base.paths = {});
      (_base1 = this.options.paths).entryPath || (_base1.entryPath = typeof rendr !== "undefined" && rendr !== null ? rendr.entryPath : void 0);
      if (this.options.paths.entryPath == null) {
        throw new Error("Missing entryPath");
      }
      (_base2 = this.options.paths).routes || (_base2.routes = this.options.paths.entryPath + '/app/routes');
      return (_base3 = this.options.paths).controllerDir || (_base3.controllerDir = this.options.paths.entryPath + '/app/controllers');
    };
    ...
    BaseRouter.prototype.buildRoutes = function() {
      var captureRoutes, e, route, routeBuilder, routes, _i, _len;
    ...
    BaseRouter.prototype.route = function() {
      var action, definitions, handler, pattern, route, routeObj;

      pattern = arguments[0], definitions = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    ...
    BaseRouter.prototype.parseDefinitions = function(definitions) {
      var element, parts, route, _i, _len;

      route = {};
      for (_i = 0, _len = definitions.length; _i < _len; _i++) {
        element = definitions[_i];
...
}, "rendr/shared/base/view": function(exports, require, module) {(function() {
  var BaseView, modelUtils, noop, templateFinder,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  module.exports = BaseView = (function(_super) {
    ...
    BaseView.prototype.parseOptions = function(options) {
      ...
      if (this.options.model != null) {
        ...
        (_base = this.options).model_name || (_base.model_name = modelUtils.modelName(this.options.model.constructor));
        this.options.model_id = this.options.model.id;
      }
      if (this.options.collection != null) {
        (_base1 = this.options).collection_name || (_base1.collection_name = modelUtils.modelName(this.options.collection.constructor));
    ...
    BaseView.prototype.fetchLazy = function() {
      ...
      fetchSpec = this.options.model_name != null ? {
        model: {
          model: this.options.model_name,
          params: params
        }
      } : this.options.collection_name != null ? {
        collection: {
      ...
      return this.app.fetch(fetchSpec, function(err, results) {
        _this.setLoading(false);
        if (err) {
          return console.log("FETCH ERR: " + err);
        }
    ...
    BaseView.prototype.hydrate = function() {
      ...
      if (!_.isEmpty(fetchSummary)) {
        ...
        return this.parseOptions(results);
      }
    };

    BaseView.prototype.setLoading = function(loading) {
      this.$el.toggleClass('loading', loading);
      return this.trigger('loading', loading);
    };
    ...
    BaseView.prototype.attachChildViews = function() {
      ...
      return this.childViews = BaseView.attach(this.app, this);
    };
    ...
    BaseView.attach = function(app, parentView) {
      ...
      scope = parentView != null ? parentView.$el : void 0;
      views = $('[data-view]', scope).map(function(i, el) {
        var $el, ViewClass, e, key, options, parsed, value, view, viewName;
...
}, "rendr/shared/fetcher": function(exports, require, module) {(function() {
  var CollectionStore, Fetcher, ModelStore, async, modelUtils,
    __hasProp = {}.hasOwnProperty;

  async = global.isServer ? require('async') : window.async;
  ...
  module.exports = Fetcher = (function() {
    ...
    Fetcher.prototype.didCheckFresh = function(spec) {
      ...
      key = this.checkedFreshKey(spec);
      return this.checkedFreshTimestamps[key] = new Date().getTime();
    };
    ...
    Fetcher.prototype._retrieve = function(fetchSpecs, options, callback) {
      ...
      return async.parallel(batchedRequests, callback);
    };
    ...
    Fetcher.prototype.storeResults = function(results) {
      var modelOrCollection, name, _results;

      _results = [];
      for (name in results) {
        if (!__hasProp.call(results, name)) continue;
        modelOrCollection = results[name];
        _results.push(modelOrCollection.store());
      }
      return _results;
    };

    Fetcher.prototype.bootstrapData = function(modelMap) {
      var map, modelOrCollection, name, results;

      results = {};
      for (name in modelMap) {
        if (!__hasProp.call(modelMap, name)) continue;
        map = modelMap[name];
    ...
    Fetcher.prototype.hydrate = function(summaries, options) {
      var collectionData, collectionOptions, models, name, results, summary;
      ...
      for (name in summaries) {
        if (!__hasProp.call(summaries, name)) continue;
    ...
    Fetcher.prototype.fetch = function(fetchSpecs, options, callback) {
      ...
      if (global.isServer) {
        if ((_ref = options.readFromCache) == null) {
          options.readFromCache = false;
        }
        if ((_ref1 = options.writeToCache) == null) {
          options.writeToCache = false;
        }
      } else {
        if ((_ref2 = options.readFromCache) == null) {
          options.readFromCache = true;
        }
        if ((_ref3 = options.writeToCache) == null) {
          options.writeToCache = true;
        }
      }
      this.pendingFetches++;
      this.trigger('fetch:start', fetchSpecs);
      return this._retrieve(fetchSpecs, options, function(err, results) {
...
}, "rendr/shared/globals": function(exports, require, module) {(function() {
...
}, "rendr/shared/handlebarsHelpers": function(exports, require, module) {(function() {
  var BaseView, modelUtils, templateFinder;
...
}, "rendr/shared/modelUtils": function(exports, require, module) {(function() {
  ...
  utils.addClassMapping = function(key, modelConstructor) {
    return classMap[utils.underscorize(key)] = modelConstructor;
  };
  ...
  utils.underscorize = function(name) {
    ...
    name = name.replace(uppercaseRe, function(char) {
...
}, "rendr/shared/store/collection_store": function(exports, require, module) {(function() {
  var CollectionStore, MemoryStore, getStoreKey, modelUtils, sortParams, _ref,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  module.exports = CollectionStore = (function(_super) {
    ...
    function CollectionStore() {
      _ref = CollectionStore.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  sortParams = function(params) {
    ...
    _.chain(params).keys().sort().forEach(function(key) {
      return sorted[key] = params[key];
    });
    return sorted;
  };

}).call(this);
}, "rendr/shared/store/local_storage_store": function(exports, require, module) {(function() {
  var LocalStorageStore, MemoryStore,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  MemoryStore = require('./memory_store');

  module.exports = LocalStorageStore = (function(_super) {
    ...
    LocalStorageStore.prototype._get = function(key) {
      var data, e, json;

      json = window.localStorage.getItem(this._formatKey(key));
      data = (function() {
        try {
    ...
    LocalStorageStore.prototype._set = function(key, data) {
      var json;

      json = JSON.stringify(data);
      window.localStorage.setItem(this._formatKey(key), json);
      return this._keys[key] = true;
    };

    LocalStorageStore.prototype._clear = function(key) {
      window.localStorage.removeItem(this._formatKey(key));
      return delete this._keys[key];
    };

    LocalStorageStore.prototype._clearAll = function() {
      var key, value, _ref;
    ...
    LocalStorageStore.canHaz = function() {
...
}, "rendr/shared/store/memory_store": function(exports, require, module) {(function() {
  var MemoryStore;
  ...
  module.exports = MemoryStore = (function() {
    ...
    MemoryStore.prototype.set = function(key, value, ttlSec) {
      ...
      expires = ttlSec ? Date.now() + ttlSec * 1000 : void 0;
      this._set(key, {
        value: value,
        expires: expires
      });
    ...
    MemoryStore.prototype._set = function(key, data) {
      return this.cache[this._formatKey(key)] = data;
    };

    MemoryStore.prototype._clear = function(key) {
      return delete this.cache[this._formatKey(key)];
    };
...
}, "rendr/shared/store/model_store": function(exports, require, module) {(function() {
  var MemoryStore, ModelStore, getModelStoreKey, modelUtils, _ref,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  module.exports = ModelStore = (function(_super) {
    ...
    function ModelStore() {
      _ref = ModelStore.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  getModelStoreKey = function(modelName, id) {
    var underscored;
...
}, "rendr/shared/syncer": function(exports, require, module) {(function() {
  var addApiParams, clientSync, extractParamNamesRe, interpolateParams, methodMap, modelUtils, objectsDiffer, qs, server, serverSync;
  ...
  clientSync = function(method, model, options) {
    var data;
  ...
  serverSync = function(method, model, options) {
    ...
    return server.dataAdapter.makeRequest(this.app.req, api, function(err, response, body) {
      if (err) {
        if (!_.isObject(body)) {
          body = {
            body: body
  ...
  addApiParams = function(method, model, params) {
    var ret;
  ...
  exports.getUrl = function(url, clientPrefix, params) {
    if (url == null) {
      url = null;
    }
    ...
    return interpolateParams(this, url, params);
  };

  exports.checkFresh = function() {
    var url, _ref,
      _this = this;

    modelUtils || (modelUtils = require('./modelUtils'));
    if ((_ref = this.app) != null) {
      _ref.trigger('checkFresh:start');
    }
    url = this.getUrl(null, true);
    return $.getJSON(url, this.params, function(resp) {
      var data, differs, _ref1;

      data = _this.parse(resp, false);
      differs = objectsDiffer(data, _this.toJSON());
      if ((_ref1 = _this.app) != null) {
        _ref1.trigger('checkFresh:end', differs);
      }
      if (differs) {
  ...
  objectsDiffer = exports.objectsDiffer = function(data1, data2) {
  ...
  exports.interpolateParams = interpolateParams = function(model, url, params) {
    var matches;
...
}, "rendr/shared/templateFinder": function(exports, require, module) {(function() {
  var fs, func, handlebarsHelpers, key, templates,
    __hasProp = {}.hasOwnProperty;
  ...
  for (key in handlebarsHelpers) {
    if (!__hasProp.call(handlebarsHelpers, key)) continue;
    func = handlebarsHelpers[key];
